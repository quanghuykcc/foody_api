...
class CategoryAPIController extends InfyOmBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $this->categoryRepository->pushCriteria(new LastSyncTimestampCriteria($request));
        
        $categories = $this->categoryRepository->orderBy('updated_at', 'desc')->all();

        $last_sync_timestamp = Carbon::now()->toDateTimeString();

        return $this->sendResponse($categories->toArray(), 'Categories retrieved successfully', $last_sync_timestamp);
    }
