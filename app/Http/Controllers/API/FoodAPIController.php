...
use Response;
use App\Http\Criteria\RestaurantIdCriteria;
use Carbon\Carbon;
...
class FoodAPIController extends InfyOmBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $this->foodRepository->pushCriteria(new RestaurantIdCriteria($request));
        $this->foodRepository->pushCriteria(new LastSyncTimestampCriteria($request));
        $foods = $this->foodRepository->all();

        $last_sync_timestamp = Carbon::now()->toDateTimeString();

        return $this->sendResponse($foods->toArray(), 'Foods retrieved successfully', $last_sync_timestamp);
    }
